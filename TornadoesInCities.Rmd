...
The shifting U.S. tornado threat
...
download.file(url = "http://www.spc.noaa.gov/gis/svrgis/zipped/1950-2020-torn-aspath.zip",
              destfile = here::here("data", "1950-2019-torn-aspath.zip"))
unzip(here::here("data", "1950-2019-torn-aspath.zip"))
}

Torn.sf <- st_read(dsn = here::here("data", "1950-2019-torn-aspath"), 
