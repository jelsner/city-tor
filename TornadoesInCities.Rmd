...
To the extent that that ratio is higher now for a given CBSA we consider it has having experienced an expanding bull's eye.
...
Check on the ratio EF2+/All over the period 2007-2020 and its correlation with population or population density.
Data source: https://www.census.gov/data/tables/time-series/demo/popest/2020s-total-metro-and-micro-statistical-areas.html#par_textimage
...
```{r}
cbsa_population <- tidycensus::get_acs(
  geography = "cbsa",
