...
## EF ratings rural versus urban impacts

Whether a tornado hits an urban area or not determines to some extent the amount damage that occurs. Here we attempt to quantify the magnitude of this extent. Specifically we ask how much less likely (on average) is EF3 (or worse) damage following a tornado impact in rural areas compared to urban areas?
...
Group tornadoes by across the urban/rural divide and examine EF rating statistics.
```{r}
